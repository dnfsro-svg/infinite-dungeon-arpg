...
struct DeathCheckpoint final {
    ...
    std::array<std::uint64_t, 5U> recent_damage{};
    std::int32_t hp{};
    std::int32_t max_hp{};
    std::int32_t barrier{};
    ...
    std::array<std::int32_t, 4U> damage_reduction{};
    std::array<std::int32_t, 4U> damage_reduction_cap{};
...
[[nodiscard]] constexpr bool zero_i32_array(
    const std::array<std::int32_t, 4U>& values) noexcept {
...
struct DungeonRunState final {
    ...
    std::array<std::uint32_t, 4U> biases{};
