...
constexpr std::array<ScenarioSpec, 6> kScenarios{{
    ...
    {"cleared", "cleared.png", "cleared.txt",
        platform::Stage11CHudValidationScenario::cleared_exit, 8U, 1600U},
    {"abyss-warning", "abyss-warning.png", "abyss-warning.txt",
        platform::Stage11CHudValidationScenario::abyss_abandon, 8U, 4000U},
    {"level-up", "level-up.png", "level-up.txt",
        platform::Stage11CHudValidationScenario::level_up_points, 8U, 1600U},
