...
arpg::test::Failure entry_templates_preserve_stage_two_layout() noexcept {
    ...
    ARPG_REQUIRE(same_position(left->player_spawn, -6.50F, 0.0F));
    ...
    ARPG_REQUIRE(same_position(right->player_spawn, 6.50F, 0.0F));
    ...
    ARPG_REQUIRE(same_position(top->player_spawn, 0.0F, -2.75F));
    ...
    ARPG_REQUIRE(same_position(bottom->player_spawn, 0.0F, 2.75F));
