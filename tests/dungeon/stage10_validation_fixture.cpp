...
Vec3 door_position(ExitDirection direction) noexcept {
    switch (direction) {
    case ExitDirection::up: return {0.0F, arpg::combat::room_bounds::min_y, 0.0F};
    case ExitDirection::down: return {0.0F, arpg::combat::room_bounds::max_y, 0.0F};
    case ExitDirection::left: return {arpg::combat::room_bounds::min_x, 0.0F, 0.0F};
    case ExitDirection::right: return {arpg::combat::room_bounds::max_x, 0.0F, 0.0F};
